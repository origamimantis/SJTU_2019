...
int main(int argc, char **argv)
{
	...
	follow = n.advertise<std_msgs::Bool>("follow", 1);
	//followModeState.data = false;
...
void followMode()
{
	...
	{
		state = !state;
		followModeState.data = state;
		follow.publish(followModeState);
	}
}
